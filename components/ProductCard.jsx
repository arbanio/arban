...
const ProductCard = ({ image, link }) => {
  return (
    <div className="w-[110px] xs:w-[130px] sm:w-[180px] md:w-[250px] xl:w-[300px] h-[200px] xs:h-[250px] sm:h-[270px] md:h-[400px] xl:h-[520px] border-2 border-gold-1 rounded-5 p-1 sm:p-3">
