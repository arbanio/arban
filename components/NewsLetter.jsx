...
const NewsLetter = () => {
  return (
    <main className="w-full bg-black-2 h-[700px]">
        ...
        <div className="w-[90%] h-[400px] m-auto mt-20 border-2 border-gold-1 rounded-5 flex">
            
            {/* ================ Form section ================ */}
            <div className="flex flex-col gap-4 w-1/2 h-full">
                <h3 className="text-xl text-center mt-10 uppercase" style={{ fontFamily: 'Amarante'}}>FEEL FREE TO GET IN TOUCH WITH US!</h3>
                <h2 className="mt-10 text-center text-2xl uppercase" style={{ fontFamily: 'Amarante'}}>Do you want to join our newsletter <br /> and receive news and updates?</h2>
            ...
            {/* =========== contact us ============= */}
            <div className="w-1/2">
                <h3 className="text-xl text-center mt-10 uppercase" style={{ fontFamily: 'Amarante'}}>We’re here for you</h3>
                <h2 className="mt-10 text-center text-2xl uppercase" style={{ fontFamily: 'Amarante'}}>Visit our Help Center</h2>
                ...
                <div className="text-center mt-20 text-2xl underline underline-offset-4 decoration-gold-1">
