...
const NewsLetter = () => {
  return (
    <main className="w-full bg-black-2 mb-3 md:mb-0 md:h-[1000px] xl:h-[700px] bg-transparent relative z-40">
        ...
        <div className="w-[90%] xl:h-[400px] m-auto mt-10 md:mt-20 border-2 border-gold-1 rounded-5 flex flex-col xl:flex-row">
            ...
            <div className="flex flex-col gap-2 xl:gap-4 w-full xl:w-1/2 h-full justify-center">
                ...
                <form className="mt-5 flex justify-center">
                    <div className="text-center border-2 border-gold-1 w-[20rem] md:w-[30rem] flex justify-between rounded-5">
                        <input type="text" placeholder="Your email address" className="w-[13rem] md:w-80 p-2 md:p-3 border-none bg-black-2" />
                        <button className="w-28 md:w-40 text-white bg-cyan-1 text-sm md:text-xl" style={{ fontFamily: 'Amarante'}} >SUBSCRIBE</button>
                    </div>
                </form>
                <p className="mt-5 text-sm md:text-base text-center" style={{ fontFamily: "Open Sans"}}>Will be used in accordance with our Privacy Policy</p>
            </div>
            ...
            <div className="w-full xl:w-1/2 flex gap-2 xl:gap-4 flex-col justify-center mt-4 xl:mt-0">
                ...
                <p className="mt-5 text-sm md:text-base text-center m-auto w-[20rem]" style={{ fontFamily: "Open Sans"}}>we will answer any question you may have about our online sales right here. Monday to Friday from 9:00 to 21:00 IST</p>
