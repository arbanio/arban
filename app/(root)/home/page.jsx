    ...
    <main>
      ...
      <div className="w-full flex justify-between h-[550px] md:h-screen relative z-40 bg-transparent">
        ...
        <div className="w-3/5 flex flex-col justify-center items-center">
          ...
          <div className=" mt-3 md:mt-5 xl:mt-10 flex justify-center"><p style={{ fontFamily: 'Amarante'}} className="w-3/5 text-center text-xs md:text-base xl:text-xl">Rose Velvet: A dusk-inspired blend of rose, cedarwood, and amber. Luxurious, feminine, and irresistibly elegant. Experience romance in every spritz.</p></div>
          ...
          <div className="flex justify-between mt-5 xl:mt-20 w-[80%]">
            <div className="w-1/2 flex flex-col justify-center items-center">
              ...
              <h6 className="text-sm md:text-base xl:text-xl mt-5" style={{ fontFamily: 'Amarante'}}>ROSE VELVET</h6>
            ...
            <div className="w-1/2 flex flex-col justify-center items-center">
              ...
              <h6 className="text-sm md:text-base xl:text-xl mt-5" style={{ fontFamily: 'Amarante'}}>IMPORTANCE</h6>
