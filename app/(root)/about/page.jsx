    ...
    <main className="h-full xl:h-screen w-full bg-black-2">
      ...
      <div className="mt-10 xl:mt-20 flex">
        <div className="w-2/5 md:w-3/5 xl:w-1/2 h-full flex flex-col gap-1 md:gap-7 md:items-end ml-2 md:ml-0">
          <p className="w-[11rem] md:w-[32rem] text-[11px] xs:text-xs md:text-base xl:text-xl" style={{ fontFamily: "Amarante" }}>
          ...
          <p className="w-[10rem] md:w-[32rem] text-[11px] xs:text-xs md:text-base xl:text-xl" style={{ fontFamily: "Amarante" }}>
        ...
        <div className="w-3/5 md:w-2/5 xl:w-1/2 h-full flex justify-end md:justify-center">
          <img
            src={"/assets/seahorse.svg"}
            className="cursor-pointer w-[350px] h-[500px] md:w-[450px] md:h-[750px]"
          />
        </div>
      </div>
