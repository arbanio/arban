  ...
  return (
    <main className="h-full xl:h-screen w-full bg-black-2">
      <div className="w-full h-[100px] flex justify-center items-center aboutBanner">
        <h1
          className="text-5xl text-black-2"
      ...
      <div className="mt-10 xl:mt-20 flex">
        <div className="w-3/5 xl:w-1/2 h-full flex flex-col gap-7 items-end">
          <p className="w-[32rem] text-base xl:text-xl" style={{ fontFamily: "Amarante" }}>
            ...
            At ARBAN, we believe that scent is more than just a fragrance—it's
          ...
          <p className="w-[32rem] text-base xl:text-xl" style={{ fontFamily: "Amarante" }}>
            ...
            are as unique and enchanting as the cities they're named after.
          ...
          <p className="w-[32rem] text-base xl:text-xl" style={{ fontFamily: "Amarante" }}>
            From the moment you experience an ARBAN fragrance, you'll embark on
            a sensory adventure unlike any other. Whether you're drawn to the
            timeless allure of floral bouquets, the exotic richness of oriental
            spices, or the refreshing crispness of citrus notes, there's an
        ...
        <div className="w-2/5 xl:w-1/2 h-full flex justify-center">
          <Image
