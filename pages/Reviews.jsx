  ...
  return (
    <main className="w-full h-[600px] md:h-screen bg-transparent relative z-40">
        <div className="w-full flex flex-col justify-center">
            <h1 className="text-xl md:text-4xl font-semibold mt-20 xl:mt-40 flex justify-center" style={{ fontFamily: 'Amarante'}}>REVIEWS</h1>

            <div className="mt-10 xl:mt-20 flex justify-around">
                {reviewData.map((data) => (
                    <ReviewCard name={data.name} img={data.img} key={data.name} description={data.description} />
                ))}
            </div>
        </div>
    </main>
