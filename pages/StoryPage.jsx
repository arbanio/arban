    ...
    <main className="w-full bg-black-2 h-[700px]">
        <div className="flex h-full">
            ...
            <div className="w-1/2 flex flex-col items-center">
                <div className="w-[250px] xl:w-300 h-[300px] xl:h-400 bg-white rounded-5 relative mt-5"></div>
                <div className="w-[250px] xl:w-300 h-[300px] xl:h-400 bg-gold-1 rounded-5 absolute top-[57rem] right-[5rem] xl:right-[7rem] xl:top-[70rem]"></div>
            </div>
        </div>
    </main>
  )
